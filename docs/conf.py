...
copyright = u"2021, Crux Informatics, Inc"
author = u"Crux Informatics, Inc."

# The short X.Y version
version = u"{version}".format(version=crux.__version__)
# The full version, including alpha/beta/rc tags
release = u"{version}".format(version=crux.__version__)
...
htmlhelp_basename = "crux-pythondoc"
...
man_pages = [(master_doc, "crux-python", u"crux-python Documentation", [author], 1)]
