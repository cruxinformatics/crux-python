...
$ rg -F '0.0.19'
README.md
27:pipenv install "crux==0.0.19"

docs/index.md
27:pipenv install "crux==0.0.19"

docs/installation.md
20:pipenv install "crux==0.0.19"
26:crux = "==0.0.19"
36:python3 -m pip install "crux==0.0.19"
...
3. In the **Tag version** field enter the version number prefixed with a *v*, e.g., `v0.0.19`. The **Target** will remain *master*, assuming the version bump commit is the latest commit on master, otherwise change the target to the bump commit.
4. In **Release title** enter the tag version, e.g., `v0.0.19`.
